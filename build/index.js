...
var _Guitar = __webpack_require__(8);

var _Guitar2 = _interopRequireDefault(_Guitar);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _Guitar2.default;
...
var _Guitar = __webpack_require__(9);
...
var _SVGText = __webpack_require__(14);

var _SVGText2 = _interopRequireDefault(_SVGText);

var _Barre = __webpack_require__(15);

var _Barre2 = _interopRequireDefault(_Barre);

var _guitarChordShape = __webpack_require__(16);

var _guitarChordShape2 = _interopRequireDefault(_guitarChordShape);
...
var Guitar = function Guitar(_ref) {
  ...
  var chordShape = _guitarChordShape2.default[chord][quality];
  var start = chordShape.s ? chordShape.s : 1;
  var chordName = '' + chord + (quality === 'MIN' ? 'm' : '');
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _SVGText2.default,
        { x: 9.5, y: 50, fill: stroke },
        start
      ),
      _react2.default.createElement(
        _SVGText2.default,
        { x: 9.5, y: 100, fill: stroke },
        start + 1
      ),
      _react2.default.createElement(
        _SVGText2.default,
        { x: 9.5, y: 150, fill: stroke },
        start + 2
      ),
      _react2.default.createElement(
        _SVGText2.default,
        { x: 9.5, y: 200, fill: stroke },
        start + 3
      ),
      _react2.default.createElement(_Barre2.default, { fret: chordShape.b, stroke: stroke }),
      chordShape.p.map(function (f, i) {
        return f > 0 && f <= 4 ? _react2.default.createElement('ellipse', {
          key: i,
          cx: 26 + 30 * i,
          cy: 50 * f,
          fill: stroke,
...
var _propTypes = {
  x: _propTypes2.number.isRequired,
  y: _propTypes2.number.isRequired,
  fontSize: _propTypes2.number,
  fill: _propTypes2.string,
  children: _propTypes2.node.isRequired
};
...
var SVGText = function SVGText(_ref) {
  var x = _ref.x,
      ...
      props = _objectWithoutProperties(_ref, ['x', 'y', 'fontSize', 'fill', 'children']);
...
var _propTypes = {
  stroke: _propTypes2.string.isRequired,
  fret: _propTypes2.number
};
var _defaultProps = {
  fret: 1
};
...
var Barre = function Barre(_ref) {
  var stroke = _ref.stroke,
      fret = _ref.fret;
  return fret > 0 ? _react2.default.createElement('ellipse', {
    cx: '100',
    cy: 50 * fret,
    fill: stroke,
    strokeWidth: '1.5',
...
var barreCommonEShape = function barreCommonEShape(s) {
  return {
    MAJ: {
      b: 1,
      s: s,
...
var barreCommonAShape = function barreCommonAShape(s) {
  return {
    MAJ: {
      b: 1,
      s: s,
